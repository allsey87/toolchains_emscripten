...
def _wasm_transition_impl(settings, attr):
    ...
    platform = "@toolchains_emscripten//:platform_wasm"
    if attr.standalone:
        platform = "@toolchains_emscripten//:platform_wasi"
        features.append("wasm_standalone")

    return {
        "//command_line_option:compiler": "emscripten",
        "//command_line_option:crosstool_top": "@toolchains_emscripten//emscripten_toolchain:everything",
        "//command_line_option:cpu": "wasm",
        "//command_line_option:features": features,
        "//command_line_option:dynamic_mode": "off",
        "//command_line_option:linkopt": linkopts,
        "//command_line_option:platforms": [platform],
        "//command_line_option:custom_malloc": "@toolchains_emscripten//emscripten_toolchain:malloc",
    }
...
_WASM_BINARY_COMMON_ATTRS = {
    ...
    "_wasm_binary_extractor": attr.label(
        ...
        allow_files = True,
        cfg = "exec",
        default = Label("@toolchains_emscripten//emscripten_toolchain:wasm_binary"),
    ),
}
