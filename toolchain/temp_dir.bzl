...
# human_readable = {},
# """.format(
#         dir_metadata.relative,
#         {k: v for k, v in sorted(entries.items())},
#         transitive_files,
#         paths.join(root_path, dir_metadata.relative) if dir_metadata.relative else root_path,
#         dir_metadata.human_readable
#     )
#     )
